...
python train_openfold.py \
    ...
    --gpus $1 \
    --num_nodes $2 \
    --resume_from_ckpt train_baseline/test/single_sequence_yiming/1p1o6bd7/checkpoints/98-346499.ckpt/ \
    --distillation_data_dir /scratch/09120/sk844/structure_dbs/ \
    --distillation_alignment_dir /scratch/09120/sk844/distillation_alignments/alignments/alignment_files/ \
    --distillation_chain_data_cache_path /scratch/09120/sk844/distillation_prot_data_cache_new.json \
    --_distillation_structure_index_path /scratch/09120/sk844/structure_dbs/super.index \
